...
const Footer = () => {
  return (
    <MaxWidthWrapper className="sm:py-20 py-8 border-t-[4px] border-black flex justify-center items-center">
      <div className="w-full flex md:flex-row flex-col md:gap-0 gap-8 sm:justify-between md:items-center  items-center justify-center">
        ...
        <h2 className="md:text-xl text-lg font-light">Portfolio Ivey, 2024</h2>
